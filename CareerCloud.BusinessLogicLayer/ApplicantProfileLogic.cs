    ...
    public class ApplicantProfileLogic : BaseLogic<ApplicantProfilePoco>
    {
        ...
        protected override void Verify(ApplicantProfilePoco[] pocos)
        {
            ...
            foreach (ApplicantProfilePoco poco in pocos)
            {
                ...
                {
                    exceptions.Add(new ValidationException(111, "Current Salary field cannot be negative."));
                }
                if (poco.CurrentRate < 0)
                {
                    exceptions.Add(new ValidationException(112, "Current Rate field cannot be negative."));
                }
            }
